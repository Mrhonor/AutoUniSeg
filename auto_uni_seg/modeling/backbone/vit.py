...
class VisionTransformer(Backbone):
    ...
    def __init__(self, ):
        ...
        hybrid_backbone=cfg.MODEL.BACKBONE.hybrid_backbone
        norm_cfg=cfg.MODEL.BACKBONE.norm_cfg
        pos_embed_interp=cfg.MODEL.BACKBONE.pos_embed_interp
        random_init=cfg.MODEL.BACKBONE.random_init
        align_corners=cfg.MODEL.BACKBONE.align_corners
