...
# config
from .config import add_maskformer2_config, add_hrnet_config, add_gnn_config, add_afformer_config, add_segmenter_config, add_setr_config
...
from .Setr_model import Setr_ARCH
