...
class Setr_ARCH(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        loss_weight_dict = {"loss_ce0": 1, "loss_ce1": 2, "loss_ce2": 1, "loss_ce3": 1, "loss_ce4": 1, "loss_ce5": 3, "loss_ce6": 3, "loss_aux0": 1, "loss_aux_weight": 0.4, "loss_spa": 0.001, "loss_adj":1, "loss_orth":10, "loss_relation": 100}
    ...
    def forward(self, batched_inputs):
        ...
        if self.Pretraining:
            ...
            if self.training:
                ...
                aux_losses = [self.clac_pretrain_loss(batched_inputs, images, targets, dataset_lbs, aux_out) for aux_out in aux_outputs]
                ...
                for idx, aux_loss in enumerate(aux_losses):
                    for k in list(aux_loss.keys()):
                        if k in self.loss_weight_dict:
                            losses[f'aux{idx}_'+k] = self.loss_weight_dict['loss_aux_weight'] * self.loss_weight_dict[k] * aux_loss[k]
                    # else:
